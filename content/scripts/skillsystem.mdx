...
- Adjust the included config files, there are 2 dummy skills included as examples, you should remove these and replace them with the skills you set up yourself.
